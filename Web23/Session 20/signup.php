            ...
            <section class="right">
                ...
                <form method="post">
                    <label for="user">
                        ...
                        <?php } else { ?>
                            <span style="color: red; font-size: 10px;"><?php echo $errors['user']; ?></span>
                    ...
                    <label for="pass">
                        ...
                        />
                        <?php } else { ?>
                            <span style="color: red; font-size: 10px;"><?php echo $errors['pass']; ?></span>
                            <input
                            class="error"
                            type="password"
                            name="pass"
                    ...
                    <label for="email">
                        ...
                        />
                        <?php } else { ?>
                            <span style="color: red; font-size: 10px;"><?php echo $errors['email']; ?></span>
                            <input
                            class="error"
                            type="email"
                            name="email"
